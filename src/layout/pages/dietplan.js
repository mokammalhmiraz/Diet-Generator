...
const Diet = () => {
    ...
    const genAI = new GoogleGenerativeAI("AIzaSyDWHdv51u0gIjFVA_D8WZze9pWSbxQFrBM");
...
//    }
    ...
    const handleGenerate = async () => {
        const userPrompt = `I am age ${age}, gender ${gender}, height ${height}cm, weight ${weight}kg, target weight ${targetWeight}. Give me a Proper Plan of diet meal for 7 days. 3 times food with snacks and also adding some details from a file.. Check that and get ideas from it. Also say about the calories and amount food I need to intake. Do not say anything extra. Just give me the information for the diet of 7 days. Start it From Day 1. here is a sample 7-day diet plan based on your provided information (age ${age}, ${gender}, ${height}cm, ${weight}kg, target ${targetWeight}kg) also I am ${diabetics}. This is a sample and should be adjusted based on your individual needs and preferences. **Consult with a doctor or registered dietitian for personalized guidance.** The calorie target is approximately 1500-1700 calories per day to promote weight loss. These are extra talks. No suggestions too. No star Marks or anything! Just me give info like this, Day 1 Breakfast:this this, Lunch: this this, Dinner This this. Do not give any Important notes or anything extra for lines or anything`;
                    ...
                    <div className="col-6">
                        <div className="diet_form">
                            ...
                            <form action="">
                                ...
                                <input type="number" placeholder='Target Weight (kg)' onChange={(e) => setTargetWeight(e.target.value)} />
                                <select name="diabetics" onChange={(e) => setDiabetics(e.target.value)}>
